...
import { ShieldCheck, Cpu, ArrowRight, Activity, FileText, Database, ShieldAlert } from 'lucide-react';
    ...
    <div style={{ animation: 'fadeIn 0.3s ease' }}>
      <div className="mp-hero">
        <div style={{ maxWidth: '600px', zIndex: 1 }}>
          <div className="mp-hero-tag">Hero Asset • BFSI</div>
          <h2 style={{ fontSize: '2.5rem', fontWeight: 900, marginBottom: '1rem', lineHeight: 1.1 }}>
            Automate 80% of Inbound Claims.
          </h2>
          <p style={{ fontSize: '1.1rem', color: '#94a3b8', marginBottom: '2rem', lineHeight: 1.5 }}>
            The Auto-Claims Resolution Agent by Cognizant instantly extracts data from FNOL emails, validates against your legacy mainframes, and drafts responses.
          </p>
          <button 
        ...
        <div style={{ zIndex: 1, display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div style={{ background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)', padding: '1rem 1.5rem', borderRadius: '1rem', border: '1px solid rgba(255,255,255,0.2)', display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <div>
              ...
              <div style={{ fontWeight: 'bold', fontSize: '1.2rem' }}>Cognizant SI</div>
            </div>
          </div>
          <div style={{ background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)', padding: '1rem 1.5rem', borderRadius: '1rem', border: '1px solid rgba(255,255,255,0.2)', display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <div>
              ...
              <div style={{ fontWeight: 'bold', fontSize: '1.2rem', color: '#34d399' }}>$0.00 (Consumption Only)</div>
            </div>
          </div>
        </div>
      </div>
